...
- **Design** view: explore component variants, sizes and states in one preview. Choose Light or Dark next to the responsive width control; the inspector edits the selected preview theme. Preview surfaces follow your tokens; editor chrome stays independent.
